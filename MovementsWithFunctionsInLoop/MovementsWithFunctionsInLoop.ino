...
void setup()                                 // Built-in initialization block
{
  ...
  servoRight.writeMicroseconds(1300);        //INCLUDE IN EVERY SCRIPT (CENTRE THE ROBOT AFTER THE RESET CLICK) 
  delay(160);
...
{
  servoLeft.writeMicroseconds(1300);         // Left wheel clockwise
  servoRight.writeMicroseconds(1672);        // Right wheel counterclockwise
  delay(time);                               // Maneuver for time ms
}
